...
class Planner(torch.nn.Module):
    def __init__(self, channels=[16, 32, 32, 32, 32, 32]):
        super().__init__()

        conv_block = lambda c, h: [torch.nn.BatchNorm2d(h), torch.nn.Conv2d(h, c, 5, 2, 2), torch.nn.ReLU(True), torch.nn.Dropout(0.3)]
